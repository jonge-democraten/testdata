...
# A collection of base64-encoded strings with various properties that have a
# relatively high probability of causing problems in different contexts.
NAUGTY_STRINGS = [
     "",
     "dW5kZWZpbmVkCg==",
     "dW5kZWYK",
...
def gen_members(n):
	...
	The output is in the same tabular format as is generated by D66 CRM.
	"""
	names = set()
	memberid = 58763
	while len(names) < n:
...
def gen_email(name):
    """Generate a plausible email address for a given name."""
